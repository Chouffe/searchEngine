...
/**
 *   Implements a BiWordindex as a Hashtable from biwords to PostingsLists.
 */
public class BiwordIndex implements Index 
{
    ...
    /**
     * Print the tf HashMap in the stdout
     */
    public void printTf()
    {
    ...
    public PostingsList getPostings( String token ) {
        ...
        {
            System.out.println("Fail with token: " + token);
        }
        /* printIndex(); */
        return null;
    }
    ...
    public PostingsList search( Query query, int queryType, int rankingType ) {
        ...
        if ( queryType == Index.PHRASE_QUERY )
        {
            ...
            for(String term: query.getTerms())
            {
                ...
                else
                {
                    ...
                    if( i == 1 )
                    {
                        result = getPostings(firstPartBigram + "-" + secondPartBigram);
                    }
                    else
                    {
                        PostingsList p2 = getPostings(firstPartBigram + "-" + secondPartBigram);
        ...
        else if ( queryType == Index.RANKED_QUERY )
        {
            ...
            result = null;
            query.buildWtq(Index.BIWORD_INDEX);
            ...
            for(String term: query.getTerms())
            {
                ...
                else
                {
                    ...
                    if( i == 1 )
                    {
                        System.out.println(firstPartBigram + "-" + secondPartBigram);
                        result = getPostings(firstPartBigram + "-" + secondPartBigram);
    ...
    protected HashMap<Integer, Double> cosineScore(Query query)
    {
        ...
        for(Map.Entry<String, Double> e: query.getWtq().entrySet())
        {
            String t = e.getKey();
            PostingsList p = getPostings(t);
